...
describe("OpenFeaturePosthogProvider", () => {
  ...
  describe("integration with OpenFeature client", () => {
    ...
    describe("getBooleanValue", () => {
      ...
      it("getBooleanValue returns false when flag is disabled", () => {
        vi.mocked(client.getFeatureFlagResult).mockReturnValue({
          key: "flag-b",
          enabled: false,
          variant: undefined,
      ...
      it("getBooleanValue returns default when flag is undefined", () => {
        vi.mocked(client.getFeatureFlagResult).mockReturnValue(undefined)

        const ofClient = OpenFeature.getClient()
        const value = ofClient.getBooleanValue("missing", true)
